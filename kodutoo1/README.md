# 1kodutoo
Andri Kaljumäe IF18, kodutöö on loodud vastavalt enda maitsele, kella tekitasin kolme eraldi funktsiooniga, esiteksin leidsin ainult aja, siis eraldi päeva ja eraldi kuu. Kujunduse tegin puhtalt läbi CSS'i, valisin kella suuruse, asukoha, värvi ja fonti. Lisaks saab leheküljele lisada ka taustapildi. Default nupp võtab kõik muutused tagasi. Minu ekraanipilt on winscp kaustas
